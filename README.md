...
* [discord.py 2.0.0a @ 45d498c1b76deaf3b394d17ccf56112fa691d160](https://github.com/Rapptz/discord.py)
  * Using `requirements.txt` installs [my fork](https://github.com/HitchedSyringe/discord.py/tree/aiohttp-unpinned) of the above repository. This fork **does not feature any code changes and only bumps `aiohttp`**, allowing for Python 3.10+ support.
